...
/*
Plugin Name: JC Skype Addon
Plugin URI:
Description: Addons skype call or message addon
...
spl_autoload_register('SkypeAddon::autoload');
...
class SkypeAddon
{
    ...
    const TEXT_DOMAIN = 'skypeadon';
    const OPTION_KEY = 'skypeaddon_rev9a';
    const FILE = __FILE__;
    ...
    private function __construct() {
        ...
        new SkypeAddon_Admin;
        new SkypeAddon_Rewrite;
    }
...
add_action('plugins_loaded', array('SkypeAddon', 'getInstance'));
?>
